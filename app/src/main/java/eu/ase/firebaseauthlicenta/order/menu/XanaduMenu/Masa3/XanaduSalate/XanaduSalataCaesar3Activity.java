package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa3.XanaduSalate;
...
public class XanaduSalataCaesar3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_salata_caesar);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_salata_caesar);
        imgAddToCart = findViewById(R.id.img_add_to_cart_caesar);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSalate3Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSalataCaesar3Activity.this)
