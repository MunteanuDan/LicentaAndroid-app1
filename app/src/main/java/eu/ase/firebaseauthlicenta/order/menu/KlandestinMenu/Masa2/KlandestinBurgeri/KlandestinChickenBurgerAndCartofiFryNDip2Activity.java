...
public class KlandestinChickenBurgerAndCartofiFryNDip2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_chicken_burger_and_cartofi_fry_n_dip);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_chicken_burger_si_cartofi_fry_n_dip_);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinChickenBurgerAndCartofiFryNDip2Activity.this)
