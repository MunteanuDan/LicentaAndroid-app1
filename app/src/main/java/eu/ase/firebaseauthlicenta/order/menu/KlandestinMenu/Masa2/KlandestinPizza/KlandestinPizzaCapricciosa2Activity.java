package eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa2.KlandestinPizza;
...
public class KlandestinPizzaCapricciosa2Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), KlandestinPizza2Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinPizzaCapricciosa2Activity.this)
