...
public class KlandestinPizzaVeggie1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_pizza_veggie);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_pizza_veggie);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinPizzaVeggie1Activity.this)
