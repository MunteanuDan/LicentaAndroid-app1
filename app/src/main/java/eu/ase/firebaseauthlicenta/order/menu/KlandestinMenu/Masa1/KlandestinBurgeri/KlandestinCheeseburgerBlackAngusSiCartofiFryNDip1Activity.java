package eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa1.KlandestinBurgeri;
...
public class KlandestinCheeseburgerBlackAngusSiCartofiFryNDip1Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), KlandestinBurgeri1Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinCheeseburgerBlackAngusSiCartofiFryNDip1Activity.this)
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (selectedComandaIndex == -1) {
                    ...
                    firebaseService.insertMasa1Klandestin(Comanda);
                } else {
                    Comanda Comanda = updateComandaFromView(Comandas.get(selectedComandaIndex).getId());
                    firebaseService.updateMasa1Klandestin(Comanda);
                }
