package eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa3.KlandestinPizza;
...
public class KlandestinPizzaCapricciosa3Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), KlandestinPizza3Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinPizzaCapricciosa3Activity.this)
