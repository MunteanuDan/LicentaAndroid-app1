package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa3.XanaduSpaghete;
...
public class XanaduPenneQuatroFormaggi3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_penne_quatro_formaggi);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_penne_quatro_formaggi);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSpaghete3Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduPenneQuatroFormaggi3Activity.this)
