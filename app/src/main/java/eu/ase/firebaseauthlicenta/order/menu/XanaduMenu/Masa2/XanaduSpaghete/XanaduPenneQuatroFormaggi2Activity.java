package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa2.XanaduSpaghete;
...
public class XanaduPenneQuatroFormaggi2Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSpaghete2Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduPenneQuatroFormaggi2Activity.this)
