package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa2.XanaduSupe;
...
public class XanaduCiorbaDeFasoleCuAfumatura2Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        ivCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ListaComenziMasa2XanaduActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSupe2Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduCiorbaDeFasoleCuAfumatura2Activity.this)
