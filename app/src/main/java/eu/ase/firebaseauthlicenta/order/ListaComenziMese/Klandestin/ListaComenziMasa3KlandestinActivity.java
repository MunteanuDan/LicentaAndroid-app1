...
public class ListaComenziMasa3KlandestinActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_comenzi_masa3_klandestin);
        ...
        return new Callback<List<Comanda>>() {
            ...
            public void runResultOnUiThread(List<Comanda> results) {
                if (results != null) {
                    ...
                    referenceComenziMasa3SumaKlandestin.setValue(s3);
    ...
    private View.OnClickListener getSaveFinalizareClickEventAlert() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(ListaComenziMasa3KlandestinActivity.this)
    ...
    private DialogInterface.OnClickListener getSaveFinalizareClickEventPositiveEvent() {
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                finish();
                Comandas3.clear();
                referenceComenziMasa3Klandestin.removeValue();
                referenceComenziMasa3Klandestin.setValue("true");
                referenceComenziMasa3SumaKlandestin.removeValue();
            }
        };
