...
public class KlandestinSpagheteCarbonara1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_spaghete_carbonara);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_spaghete_carbonara);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinSpagheteCarbonara1Activity.this)
