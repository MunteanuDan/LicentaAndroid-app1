...
public class XanaduSupe1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        supa_de_put_cu_galuste_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(XanaduSupe1Activity.this, XanaduSupaDePuiCuGaluste1Activity.class);
        ...
        ciorba_de_fasole_cu_afumatura_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(XanaduSupe1Activity.this, XanaduCiorbaDeFasoleCuAfumatura1Activity.class);
                startActivity(intent);
            }
        });
        ...
        ciorba_de_vacuta_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(XanaduSupe1Activity.this, XanaduCiorbaDeVacuta1Activity.class);
                startActivity(intent);
            }
        });
        ...
        cart_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(XanaduSupe1Activity.this, ListaComenziMasa1XanaduActivity.class);
                startActivity(intent);
            }
        });
