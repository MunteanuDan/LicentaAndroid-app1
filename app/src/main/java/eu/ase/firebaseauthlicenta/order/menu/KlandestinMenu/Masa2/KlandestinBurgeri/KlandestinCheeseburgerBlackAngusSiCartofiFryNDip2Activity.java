package eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa2.KlandestinBurgeri;
...
public class KlandestinCheeseburgerBlackAngusSiCartofiFryNDip2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_cheeseburger_black_angus_si_cartofi_fry_n_dip);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_cheeseburger_black_angus_si_cartofi_fry_n_dip);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), KlandestinBurgeri2Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinCheeseburgerBlackAngusSiCartofiFryNDip2Activity.this)
        ...
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                if (selectedComandaIndex == -1) {
                    ...
                    firebaseService.insertMasa2Klandestin(Comanda);
                } else {
                    Comanda Comanda = updateComandaFromView(Comandas.get(selectedComandaIndex).getId());
                    firebaseService.updateMasa2Klandestin(Comanda);
                }
