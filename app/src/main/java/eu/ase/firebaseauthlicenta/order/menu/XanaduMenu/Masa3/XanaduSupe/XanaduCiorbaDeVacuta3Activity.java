...
public class XanaduCiorbaDeVacuta3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_ciorba_de_vacuta);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_ciorba_de_vacuta);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduCiorbaDeVacuta3Activity.this)
