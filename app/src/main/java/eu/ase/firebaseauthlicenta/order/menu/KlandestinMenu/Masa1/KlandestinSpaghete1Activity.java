...
import eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa1.KlandestinSpaghete.KlandestinPennePollo1Activity;
import eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa1.KlandestinSpaghete.KlandestinSpagheteCarbonara1Activity;
import eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa1.KlandestinSpaghete.KlandestinSpagheteFormagiAndPere1Activity;

public class KlandestinSpaghete1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        klandestin_spaghete_carbonara_iv.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(KlandestinSpaghete1Activity.this, KlandestinSpagheteCarbonara1Activity.class);
        ...
        klandestin_spaghete_formagi_and_pere_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KlandestinSpaghete1Activity.this, KlandestinSpagheteFormagiAndPere1Activity.class);
                startActivity(intent);
            }
        });
        ...
        klandestin_penne_pollo_iv.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                Intent intent = new Intent(KlandestinSpaghete1Activity.this, KlandestinPennePollo1Activity.class);
                startActivity(intent);
            }
        });
