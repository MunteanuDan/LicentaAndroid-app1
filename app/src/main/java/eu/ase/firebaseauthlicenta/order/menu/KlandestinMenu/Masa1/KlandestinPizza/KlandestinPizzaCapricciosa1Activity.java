package eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa1.KlandestinPizza;
...
public class KlandestinPizzaCapricciosa1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_pizza_capricciosa);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_pizza_capricciosa);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), KlandestinPizza1Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinPizzaCapricciosa1Activity.this)
