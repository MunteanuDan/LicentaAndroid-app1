...
public class KlandestinPizzaMargherita1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_pizza_margherita);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_pizza_margherita);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinPizzaMargherita1Activity.this)
