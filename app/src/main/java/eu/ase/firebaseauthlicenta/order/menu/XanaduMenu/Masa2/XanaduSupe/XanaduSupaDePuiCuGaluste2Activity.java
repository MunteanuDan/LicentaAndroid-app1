...
public class XanaduSupaDePuiCuGaluste2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_supa_de_pui_cu_galuste);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_supa_de_pui_cu_galuste);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSupaDePuiCuGaluste2Activity.this)
