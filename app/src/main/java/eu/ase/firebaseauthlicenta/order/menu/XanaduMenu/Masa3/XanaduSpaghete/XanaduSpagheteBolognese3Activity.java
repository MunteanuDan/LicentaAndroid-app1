...
public class XanaduSpagheteBolognese3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_spaghete_bolognese);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_spaghete_bolognese);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSpagheteBolognese3Activity.this)
