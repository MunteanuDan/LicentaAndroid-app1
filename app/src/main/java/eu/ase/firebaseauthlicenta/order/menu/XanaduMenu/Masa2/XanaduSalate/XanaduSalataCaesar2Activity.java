package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa2.XanaduSalate;
...
public class XanaduSalataCaesar2Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSalate2Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSalataCaesar2Activity.this)
