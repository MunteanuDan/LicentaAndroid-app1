...
public class XanaduSalataMexicana2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_salata_mexicana);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_salata_mexicana);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSalataMexicana2Activity.this)
