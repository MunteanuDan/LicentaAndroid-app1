package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa1.XanaduSupe;
...
public class XanaduCiorbaDeFasoleCuAfumatura1Activity extends AppCompatActivity {
    ...
    private void initComponents() {
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSupe1Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduCiorbaDeFasoleCuAfumatura1Activity.this)
