...
import static eu.ase.firebaseauthlicenta.order.firebase.FirebaseService.referenceComenziMasa2SumaXanadu;
import static eu.ase.firebaseauthlicenta.order.firebase.FirebaseService.referenceComenziMasa2Xanadu;

public class ListaComenziMasa2XanaduActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_lista_comenzi_masa2_xanadu);

        firebaseService = FirebaseService.getInstance();
        initComponents();
        firebaseService.attachDataChangeEventListener2(dataChangeCallback());
        ...
        return new Callback<List<Comanda>>() {
            ...
            public void runResultOnUiThread(List<Comanda> results) {
                if (results != null) {
                    ...
                    referenceComenziMasa2SumaXanadu.setValue(s2);
    ...
    private View.OnClickListener getSaveFinalizareClickEventAlert() {
        return new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(ListaComenziMasa2XanaduActivity.this)
    ...
    private DialogInterface.OnClickListener getSaveFinalizareClickEventPositiveEvent() {
        return new DialogInterface.OnClickListener() {
            ...
            public void onClick(DialogInterface dialog, int which) {
                ...
                finish();
                Comandas2.clear();
                referenceComenziMasa2Xanadu.removeValue();
                referenceComenziMasa2Xanadu.setValue("true");
                referenceComenziMasa2SumaXanadu.removeValue();
            }
        };
