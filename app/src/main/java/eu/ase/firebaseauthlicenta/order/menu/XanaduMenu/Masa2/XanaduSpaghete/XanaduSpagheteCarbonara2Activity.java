...
public class XanaduSpagheteCarbonara2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_spaghete_carbonara);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_spaghete_carbonara);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSpagheteCarbonara2Activity.this)
