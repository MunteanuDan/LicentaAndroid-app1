...
public class KlandestinPennePollo2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_penne_pollo);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_penne_pollo);
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinPennePollo2Activity.this)
