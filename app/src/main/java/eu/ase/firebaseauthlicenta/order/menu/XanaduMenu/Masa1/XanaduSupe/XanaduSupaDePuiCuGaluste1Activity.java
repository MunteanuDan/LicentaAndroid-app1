...
public class XanaduSupaDePuiCuGaluste1Activity extends AppCompatActivity {
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduSupaDePuiCuGaluste1Activity.this)
