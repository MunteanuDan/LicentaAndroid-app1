package eu.ase.firebaseauthlicenta.order.menu.XanaduMenu.Masa3.XanaduSupe;
...
public class XanaduCiorbaDeFasoleCuAfumatura3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_xanadu_ciorba_de_fasole_cu_afumatura);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_ciorba_de_fasole_cu_afumatura);
        ...
        ivCart.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                Intent intent = new Intent(getApplicationContext(), ListaComenziMasa3XanaduActivity.class);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), XanaduSupe3Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(XanaduCiorbaDeFasoleCuAfumatura3Activity.this)
