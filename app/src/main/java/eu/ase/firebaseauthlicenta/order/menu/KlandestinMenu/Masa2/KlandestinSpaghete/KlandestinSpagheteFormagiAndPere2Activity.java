package eu.ase.firebaseauthlicenta.order.menu.KlandestinMenu.Masa2.KlandestinSpaghete;
...
public class KlandestinSpagheteFormagiAndPere2Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_klandestin_spaghete_formagi_and_pere);
    ...
    private void initComponents() {
        tvDenumire = findViewById(R.id.tv_klandestin_spaghete_formagi_si_pere);
        ...
        back.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                Intent intent = new Intent(getApplicationContext(), KlandestinSpaghete2Activity.class);
                startActivity(intent);
            }
        });
    ...
    private View.OnClickListener getSaveComandaClickEventAlert() {
        return new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                AlertDialog.Builder build = new AlertDialog.Builder(KlandestinSpagheteFormagiAndPere2Activity.this)
