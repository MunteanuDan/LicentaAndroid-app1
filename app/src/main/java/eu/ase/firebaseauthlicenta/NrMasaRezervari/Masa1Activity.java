...
public class Masa1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReferenceUsers = mRootRef.child("rezervari4").child(CalendarActivity.selectedDate).child("1");
    ...
    public void btnApply1(View v) {
        ...
        DatabaseReference databaseReferenceUsers = mRootRef.child("rezervari4").child(CalendarActivity.selectedDate).child("1");
        DatabaseReference databaseReferenceUsers1 = mRootRef.child("rezervari4").child(CalendarActivity.selectedDate).child("1").child(userId);
