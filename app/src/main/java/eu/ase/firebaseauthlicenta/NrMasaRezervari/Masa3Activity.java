...
public class Masa3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        DatabaseReference databaseReferenceUsers = mRootRef.child("rezervari4").child(CalendarActivity.selectedDate).child("3");
    ...
    public void btnApply1(View v) {
        ...
        DatabaseReference databaseReferenceUsers = mRootRef.child("rezervari4").child(CalendarActivity.selectedDate).child("3");
        DatabaseReference databaseReferenceUsers1 = mRootRef.child("rezervari4").child(CalendarActivity.selectedDate).child("3").child(userId);
